...
/**
 * Title: Footer links
 * Slug: carbon-agency/footer-links
 * Categories: text
 * Inserter: no
 *
...
<div class="wp-block-group alignfull">
	...
	<div class="wp-block-group">
		...
		printf(
			...
			esc_html__( 'Copyright %s. ', 'carbon-agency' ),
			esc_html( date_i18n( _x( 'Y', 'copyright date format', 'carbon-agency' ) ) ),
		);
		esc_html_e( 'All right reserved.', 'carbon-agency' );
		?>
		</p>
